...
const About = () => {
  return (
    <div name="about" className="bg-gradient-to-b from-gray-800 to-black w-full min-h-screen text-white pt-20 pb-20">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="text-xl text-gray-300 leading-relaxed mt-4 sm:mt-0">
          <p className="mb-4">
