    ...
    <div className='hidden lg:flex flex-col top-[35%] left-0 fixed z-10'>
        <ul>
            {links.map(({id, child, href, style, download}) => (
                <li key={id} className={'flex justify-between items-center w-40 h-14 px-4 bg-gradient-to-r from-purple-400 via-blue-500 to-pink-400 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration:300 ' + style}>
                    <a 
                      href={href} 
